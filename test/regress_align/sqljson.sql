...
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON('123');
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON('123' FORMAT JSON);
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON('123'::bytea FORMAT JSON);
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON('123'::bytea FORMAT JSON ENCODING UTF8);
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON('123' WITH UNIQUE KEYS);
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON('123' WITHOUT UNIQUE KEYS);
...
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON_SCALAR(123);
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON_SCALAR('123');
...
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON_SERIALIZE('{}');
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON_SERIALIZE('{}' RETURNING bytea);
...
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON_OBJECT('a': JSON_OBJECTAGG('b': volatile_one() RETURNING text) FORMAT JSON);
SELECT JSON_OBJECT('a': JSON_OBJECTAGG('b': volatile_one() RETURNING text) FORMAT JSON);
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON_OBJECT('a': JSON_OBJECTAGG('b': stable_one() RETURNING text) FORMAT JSON);
SELECT JSON_OBJECT('a': JSON_OBJECTAGG('b': stable_one() RETURNING text) FORMAT JSON);
EXPLAIN (VERBOSE, COSTS ON) SELECT JSON_OBJECT('a': JSON_OBJECTAGG('b': 1 RETURNING text) FORMAT JSON);
