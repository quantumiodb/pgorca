...
explain (costs ON) select * from nv_parent where d between '2011-08-01' and '2011-08-31';
create table nv_child_2009 (check (d between '2009-01-01'::date and '2009-12-31'::date)) inherits (nv_parent);
explain (costs ON) select * from nv_parent where d between '2011-08-01'::date and '2011-08-31'::date;
explain (costs ON) select * from nv_parent where d between '2009-08-01'::date and '2009-08-31'::date;
...
\d+ at_view_1
\d+ at_view_2
explain (verbose, costs ON) select * from at_view_2;
