...
EXPLAIN (COSTS ON) SELECT * FROM atest12v x, atest12v y WHERE x.a = y.b;

-- And this one.
EXPLAIN (COSTS ON) SELECT * FROM atest12 x, atest12 y
  WHERE x.a = y.b and abs(y.a) <<< 5;

-- This should also be a nestloop, but the security barrier forces the inner
-- scan to be materialized
EXPLAIN (COSTS ON) SELECT * FROM atest12sbv x, atest12sbv y WHERE x.a = y.b;
...
EXPLAIN (COSTS ON) SELECT * FROM atest12 WHERE a >>> 0;
EXPLAIN (COSTS ON) SELECT * FROM atest12v WHERE a >>> 0;
EXPLAIN (COSTS ON) SELECT * FROM atest12sbv WHERE a >>> 0;
...
EXPLAIN (COSTS ON) SELECT * FROM atest12v x, atest12v y
  WHERE x.a = y.b and abs(y.a) <<< 5;

-- But a security barrier view isolates the leaky operator.
EXPLAIN (COSTS ON) SELECT * FROM atest12sbv x, atest12sbv y
  WHERE x.a = y.b and abs(y.a) <<< 5;
