...
EXPLAIN (costs ON) SELECT * FROM mpp18162_int WHERE i1 = 2;
...
-- EXPLAIN shows ORCA static partition pruning
EXPLAIN (costs ON) SELECT * FROM mpp18162_text WHERE i1 = '2';
...
-- EXPLAIN shows ORCA static partition pruning
EXPLAIN (costs ON) SELECT * FROM mpp18162_date WHERE i1 = '2008-03-01';
